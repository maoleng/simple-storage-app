@if ($is_mobile)
    <link rel="stylesheet" href="{{asset('css/style-mobilee.css')}}">
@else
...
<div class="login-box">
    <h1>STORAGE APP</h1>
    <form action="{{route('store')}}" method="post" id="file-upload-form" class="uploader" enctype="multipart/form-data">
        @csrf
...
{{--        --}}
        <input id="file-upload" type="file" name="file_image" accept="image/*" />

        <label for="file-upload" id="file-drag" class="label_upload">
